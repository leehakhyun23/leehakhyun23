...
public class A_if {
    public void iftest() {
        ...
        /* 조건식 : true or flase가 나오는 연산식을 조건식이라고 한다.
         * if문은 조건식 결과 값이 참이면 {}안에 코드를 싱행하고,
         * 조건식의 결과가 거짓이면 {}안에 코드를 무시하고 넘어감. */
        ...
        int num = sc.nextInt();
        if( num % 2 == 0){
            System.out.println("입력 받은 수는 짝수 입니다. ");
        }
        System.out.println("프로그램을 종료합니다.");
    }
    public void testifif(){
        /* 수업 목표. 중첩 if문의 흐름을 이해하고 적용할 수 있다.
        * 중첩된 if 문 실행 흐름 확인 */
        ...
        * 둘 중 하나라도 해당하지 않으면 아무 내용도 출력하지 않는 구문을 작성해보자*/
        ...
        if(num1 > 0) {
            if (num1 % 2 == 0) {
                System.out.println("입력하신 수는 양수이면서 짝수입니다.");
            }
            System.out.println("프로그램을 종료합니다.");
        }
