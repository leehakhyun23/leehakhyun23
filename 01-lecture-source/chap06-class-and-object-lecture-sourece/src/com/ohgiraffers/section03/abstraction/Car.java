...
public class Car {
    ...
    private boolean isOn; //초기에는 시동이 꺼진 상태 false 상태이다.
    ...
    public void go(){
        if(isOn) {
            ...
            this.speed += 10;
            System.out.println("현재 차의 시속은 " + speed + " 입니다. ");
        }
        else{
            System.out.println("차에 시동이 걸려있지 않았습니다. 시동을 먼저 걸어주세요");
        }
    }
    public  void stop(){
        if(isOn){
    ...
    public void turnOff(){
        if(isOn){
            ...
            System.out.println("이미 시동이 꺼저 있는상태입니다. 시동 상태를 확인해주세요 ");
        }
    }
}
