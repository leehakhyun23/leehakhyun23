...
public class Application {
    public static void main(String[] args) {
        /*  객제지향 프로그래밍에 대해 이해하고 객체와 클래스를 설계하여 프로그래밍 할 수 있다.
         *  객체 지향 프로그래밍이란
        ...
        /*
        * 객체를 설계하기 위해서는 복잡한 현실 세계를 그대로 반영하기에는 너무 방대하고 복잡하기 때문에
        * 현실세계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법을 적용하게 된다.*/
        /*
        * 추상화란?
        * 공통된 부분을 추출하고 공통되지 않은 부분을 제거한다는 의미를 가지며, 추상화의 목적은 유연성을
        * 확보하기 위함이다. 유연성 학보는 여러곳에 적용할 수 있는 유일한 객체를 의미하며, 즉, 재사용성이 높아질 수 있다는
        * 의미이다. 객체의 재사용성이 증가하면 중복 작성되는 코드를 줄일 수 있으며, 오류 발생 가능성을
        * 감소시키고 유지보수성을 증가시킨다.
        *
		 *  객체와 객체의 상호작용이란?
        ...
        *  - 사용자, 카레이서, 자동차
        * 2. 객체간의 상호작용
        *  - 카레이서가 수신할 수 있는 메시지 (카레이서가 해야하는일 )
        * 1. 시동을 걸어라
        * 2. 엑셀을 밟아라
        * 3. 브레이크를 밟아라
        * 4. 시동을 꺼라
        *  - 자동차가 수신할 수 있는 메시지( 자동차가 해야하는일 )
        * 1. 시동을 걸어라
        * 2. 앞으로가라
        * 3, 멈춰라
        * 4. 시동을 꺼라
