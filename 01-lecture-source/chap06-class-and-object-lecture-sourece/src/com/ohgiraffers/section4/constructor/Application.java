...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        /* 생성자란 ?
        * 인스턴스 생성할 때 초기 수행할 명령이 있는 경우 미리 작성해두고 ,인스턴스를 생성할 때 호출한다.
        * 생성자 함수에 매개변수가 없는 생성자를 기본 생성자(default constructor)라고 하며
        * 기본생성자는 compiler 에서 자동으로 추가되기 때문에 지금껏 명시적으로 작성하지 않고 사용할 수 있었다.
        ...
        * */
        /* 매개변수를 전달 받는 생성자를 호출해 인스턴스 생성 후 필드갑 출력*/
        user user1 = new user();
        System.out.println();
        System.out.println(user1.getimformation());
