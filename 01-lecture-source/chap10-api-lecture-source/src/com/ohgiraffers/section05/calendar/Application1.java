...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 1.기본생성자 사용하는 방법 */
        /* 기본생성자로 인스턴스를 생성하는 운영체제의 날짜/시간 정보를 이용해서 인스턴스를 만들게 된다. */

        Date today = new java.util.Date();

        System.out.println(today);
        /* 2. Date(long date) 사용하는 방법 */
        /* getTime이라는 메소드 1970년 1월 1일 0시 0분 0초를 지난시간을 millisecond로 계산해서 long타입으로 반환한다.*/

        System.out.println(today.getTime()); //1712127097907
        Date time = new Date(1712127097907L);
