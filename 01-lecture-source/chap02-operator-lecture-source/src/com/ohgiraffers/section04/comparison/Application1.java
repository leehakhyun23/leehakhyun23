...
public class Application1 {
    public static void main(String[] args){
        ...
        * '>' : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 크면 true 아니면 false를 반환한다.
        * '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 크거나 같으면 true 아니면 false를 반환한다.
        * '<' : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 작으면 true 아니면 false를 반환한다.
        * '<=' : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 작거나 같으면 true 아니면 false를 반환한다.
        * */
