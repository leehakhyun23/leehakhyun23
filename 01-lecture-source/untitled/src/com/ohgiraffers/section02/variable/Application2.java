...
public class Application2 {
    public static void main (String[] args){
        /* 수업 목표, 변수의 선언하고 값을 할당하여 사용할 수 있다.*/
        /* 변수를 사용하는 방법
        1. 변수를 준비한다.
        2. 변수의 값을 대입한다.
        3. 변수를 사용한다.
        * */
        ...
        /* 자료형이란?
        * 다양한 값의 형태별로 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리 컴파일러와 약속한 키워드이다.
        * 예) 앞에서 사용한 int 자료형은 정수를 4byte만큼 읽어서 하나의 값으로 취급하겠다는 약속이다.
        *   이러한 자료형은 기본자료형(Primary type)과 참조자료형(Referance type)으로 나누어진다.
        *   그 중 기본자료형 8가지부터 살표보기로 한다.
        * */
        ...
        *  목차 2-1 정수를 취급하는 자료형에 값 대입*/
        ...
        /* 일반적으로 사용하는 독특한 형태가 아닌 일반적읜 형태로 사용할 수 있는 자료형을 대표자료형이라고 한다.
