...
public class Application6 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*리턴값을 반환받기 위해서는 메소드 선언부에 리턴타입을 명시해 주어야한다.
        void는 아무 반환값도 가지지 않겠다는 리턴타입에 사용할 수 있는 키워드이다.
        반환값이 없는 경우 return 구문을 생략해도 컴파일러가 자동으로 추가해주만,
        반환값이 있는경우 retrun구문을 작성해야해
        또한 메소드 선언부에 선언한 리턴 타입 반환값의 자료형은 반드시 일치하여하한다.
        * */
        ...
        String returnText = app6.textMethod();

        System.out.println(returnText);
        System.out.println(app6.textMethod());
