...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 클래스명은 원래 패키지명을 포함 되어있기 때문이다. 예)package com.ohgiraffers.section01.method.Calculator;
         ...
         * */
        /* non-static 메소드의 경우 */
        com.ohgiraffer.section01.method.Calculator cal = new com.ohgiraffer.section01.method.Calculator();
        int min = cal.minNumberOf(30,20);

        System.out.println("30과 20중에 작은 값은? " + min );

        int max = com.ohgiraffer.section01.method.Calculator.maxNumberOf(30,20);
