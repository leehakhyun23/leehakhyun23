...
public class Application {
    public static void main(String[] args) {
        ...
        * 추상클래스 클래스 선언부에 abstract 키워드를 명시해야한다.
        * 추상클래스로는 인스턴스 생성이 불가능하다.
        * 추상클래스를 사용하려면 추상 클래스를 상속받는 하위 클래스를 이용하여, 인스턴스를 생성해야한다.
        * 이 때 추상 클래스는 상위타입으로 사용될 수 있으며 다형성을 이용할 수 있다.
        * */

        /* 추상클래스에 작성된 추상메소드는 반드시 후손이 오버라이딩해서 작성해야하며
        ...
        * 추상 메소드의 경우 abstract 키워드를 메소드 헤드에 작성해야한다.
        *
        ...
        *  */
        ...
        Product product = new SmartPhone(); // 타입형변환 UP casting
        product.absMethod();
        ...
        * 따라서 여러 클래스들을 그룹화하여
        * 필수 기능을 정의하여 강제성을 부여해 개발 시 일관된 인터페이스 제공할 수 있다.
        * */

        /*
        * 하지만 다른 클래스를 상속 받고 있는 클래스를 작성할 시에는 추상클래스를 추가로 상속받을 수 없다
        * 그래서 추상 클래스보다 더 강제성이 강한 인터페이스(interface)라는 메커니즘을 제공하고 있다.
        * */
    }
}
