...
public class Member_Insert {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println("전화번호를 입력히세요 -> ");
		mdto.setPhone(sc.nextLine());
		
		System.out.print(" 성별을 입력하세요(M/F) ->" );
		mdto.setGender(sc.nextLine());
		// bpoint 는 default 값이 0이므로 별도로 입력받지않습니다
		...
		//sdf객체에 날짜데이터 하나를 적용하면 "yyyy-MM-dd" 양식으로 날짜데이터를 설정하여 사용할 수 있습니다.
		// 또한 SimpleDataFormat 클래스의 parse 메소드는 String 양식의 날짜 데이터를 
		...
		//java.util.Date 을 java.sql.Date로 변환
