...
//컬렉션 클래스
//자료구조를 구현하고 있는 클래스
//자료구조 : 각각의 데이터들을 효율적으로 저장하고 운용하기 위한방법론
 ...
 * 4. Map
 * */
// 리스트 클래스를 상속받은 ArrayList 또는  Vector 사용 빈도가 가장 높음
// Map 클래스를 상속받은 HashTable 또는 HashMap 또한 못지 않게 사용빈도수가 높고 중요하게 사용됩니다
...
public class Collection {
	...
	public static void main(String[] args) {
		...
		// Vector 와 ArrayList 저장은 int형이 아닌 Integer형 데이터(객체)가 저장된다.
		
		//ArrayList 안에 add 멤버 메서드가 존재하고 그 메서드를 통해 데이터를 저장 
		//a.add("abc");
		//v.add("abc");
		// add 메소드의 매개변수는 oObject 인것을 예상할 수 있다.
