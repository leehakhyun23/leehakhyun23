...
//한개 이상의 자료ㅡ 하나이상의 자료형을 저장할 수 있는 복합 자료형

/* 클래스는 프로그램 단위로도 사용된다
 * 클래스 = 자바의 프로그램 단위
 * 하나의 파일안에 여러개의 클래스를 정의하여 사용이 가능합니다
 * 다만 여러개의 클래스 중 하나는 파일이름과 반드시 같아야하고, public 이어야하며,
 * 자체 실행여부에 따라 public static void main() {} 를 포함하고 있어야한다.
 */
public class Variable01 {
 
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			Score std1 =new Score(); //std1 : 참조변수 new Score() : 인스턴스
			
			//String str = "Korea";
			//String str = new String("Korea");
			// new Scores() 에 의해서 Heap 영역에 필요한 만큼 메모리를 확보하고 그 주소를 참조변수 std1에 전달한
		
			//System.out.println("너무나 쉬운 자바");
			//int[] kor = new int[5];
			//int[] eng = new int[5];
			//int[] mat = new int[5];
